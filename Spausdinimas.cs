...
namespace ipaantras
{
    class Spausdinimas
    {
        ...
        public static void rezspausdinimasfailas()
        {
            ...
            for (int i = 0; i < Studentai.studentukiekis; i++)
            {
                Console.WriteLine(Studentai.vardasstringlist[i].PadRight(12) + Studentai.pavardestringlist[i].PadRight(10) + "".PadRight(9) + $"{Studentai.galutinisdoublelist[i]:0.00}".PadRight(15) + $"{Studentai.galutinismedianadoublelist[i]:0.00}");
            }
        }
        ...
        public static void rezifailaSuLinkedList()
        {
            try
            {
                StreamWriter sw = new StreamWriter("D:\\Files\\Darbai(Disk D)\\Programavimas\\ipaantras\\ipaantras\\SugeneruotiSarasai\\" + Studentai.failovardas + ".txt");
                ...
                for (int i = 0; i < Studentai.studentukiekis; i++)
                {
                    sw.WriteLine(Studentai.vardasstringLList.ElementAt(i).PadRight(15) + Studentai.pavardestringLList.ElementAt(i).PadRight(15) + "".PadRight(9) + $"{Studentai.galutinisdoubleLList.ElementAt(i):0.00}".PadRight(15) + $"{Studentai.galutinismedianadoubleLList.ElementAt(i):0.00}");
                    if (Studentai.galutinisdoubleLList.ElementAt(i) < 5.0)
                    {
                        swvargsiukai.WriteLine(Studentai.vardasstringLList.ElementAt(i).PadRight(15) + Studentai.pavardestringLList.ElementAt(i).PadRight(15) + "".PadRight(9) + $"{Studentai.galutinisdoubleLList.ElementAt(i):0.00}".PadRight(15) + $"{Studentai.galutinismedianadoubleLList.ElementAt(i):0.00}");
                    }
                    else
                    {
                        swkietiakai.WriteLine(Studentai.vardasstringLList.ElementAt(i).PadRight(15) + Studentai.pavardestringLList.ElementAt(i).PadRight(15) + "".PadRight(9) + $"{Studentai.galutinisdoubleLList.ElementAt(i):0.00}".PadRight(15) + $"{Studentai.galutinismedianadoubleLList.ElementAt(i):0.00}");
                    }
                }
        ...
        public static void reziFailaSuQueue()
        {
            try
            {
                StreamWriter sw = new StreamWriter("D:\\Files\\Darbai(Disk D)\\Programavimas\\ipaantras\\ipaantras\\SugeneruotiSarasai\\" + Studentai.failovardas + ".txt");
                ...
                for (int i = 0; i < Studentai.studentukiekis; i++)
                {
                    sw.WriteLine(Studentai.vardasstringQueue.ElementAt(i).PadRight(15) + Studentai.pavardestringQueue.ElementAt(i).PadRight(15) + "".PadRight(9) + $"{Studentai.galutinisdoubleQueue.ElementAt(i):0.00}".PadRight(15) + $"{Studentai.galutinismedianadoubleQueue.ElementAt(i):0.00}");
                    if (Studentai.galutinisdoubleQueue.ElementAt(i) < 5.0)
                    {
                        swvargsiukai.WriteLine(Studentai.vardasstringQueue.ElementAt(i).PadRight(15) + Studentai.pavardestringQueue.ElementAt(i).PadRight(15) + "".PadRight(9) + $"{Studentai.galutinisdoubleQueue.ElementAt(i):0.00}".PadRight(15) + $"{Studentai.galutinismedianadoubleQueue.ElementAt(i):0.00}");

                    }
                    else
                    {
                        swkietiakai.WriteLine(Studentai.vardasstringQueue.ElementAt(i).PadRight(15) + Studentai.pavardestringQueue.ElementAt(i).PadRight(15) + "".PadRight(9) + $"{Studentai.galutinisdoubleQueue.ElementAt(i):0.00}".PadRight(15) + $"{Studentai.galutinismedianadoubleQueue.ElementAt(i):0.00}");
                    }
                }
        ...
        public static void reziFailaBeKietiaku()
        {
            try
            {
                StreamWriter sw = new StreamWriter("D:\\Files\\Darbai(Disk D)\\Programavimas\\ipaantras\\ipaantras\\SugeneruotiSarasai\\" + Studentai.failovardas + ".txt");
        ...
        public static void rezifailaBeKietiakuSuLinkedList()
        {
            try
            {
                StreamWriter sw = new StreamWriter("D:\\Files\\Darbai(Disk D)\\Programavimas\\ipaantras\\ipaantras\\SugeneruotiSarasai\\" + Studentai.failovardas + ".txt");
        ...
        public static void reziFailaBeKietiakuSuQueue()
        {
            try
            {
                StreamWriter sw = new StreamWriter("D:\\Files\\Darbai(Disk D)\\Programavimas\\ipaantras\\ipaantras\\SugeneruotiSarasai\\" + Studentai.failovardas + ".txt");
        ...
        public static void reziFailaBeKietiakuSuŠalinimu()
        {
            try
            {
                StreamWriter sw = new StreamWriter("D:\\Files\\Darbai(Disk D)\\Programavimas\\ipaantras\\ipaantras\\SugeneruotiSarasai\\" + Studentai.failovardas + ".txt");
                ...
                for (int i = 0; i < Studentai.studentukiekis; i++)
                {
                    Studentai.vardasstringlist.RemoveAt(i);
                    Studentai.pavardestringlist.RemoveAt(i);
                    Studentai.galutinisdoublelist.RemoveAt(i);
                    Studentai.galutinismedianadoublelist.RemoveAt(i);
